...
#define LCD_UPDATE_INTERVAL_PRINTING_SERIAL    800 //!< If printing over serial, we only need to update every second or so, as most of the info is available via OctoPrint
